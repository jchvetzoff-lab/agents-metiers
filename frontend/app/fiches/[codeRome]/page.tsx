...
export default function FicheDetailPage() {
  ...
  const sections = [
    ...
    { id: "validation", label: "Validation", icon: "✅", show: authenticated },
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-8">
        <div className="flex gap-8">
          ...
          <div className="flex-1 min-w-0 space-y-6">
            ...
            {/* ═══ SECTION VALIDATION (Authentifiée uniquement) ═══ */}
            {authenticated && (
                ...
                <div className="mb-8">
                  <div className="flex items-center justify-center mb-4">
                    <div className="flex items-center gap-4 text-sm">
                      ...
                      <span className="text-gray-300">→</span>
                      <div className={`flex items-center gap-2 px-4 py-2 rounded-lg ${fiche.statut === 'publie' ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-500'}`}>
                        <span className={`w-2 h-2 rounded-full ${fiche.statut === 'publie' ? 'bg-green-500' : 'bg-gray-400'}`} />
                        3. Publication
                      </div>
                    </div>
                  </div>
                        ...
                        <div className="flex-1">
                          ...
                          <div className="w-full h-3 bg-gray-200 rounded-full overflow-hidden">
                            <div 
                              ...
                              style={{ width: `${fiche.validation_ia_score}%` }}
                            />
                          </div>
                        </div>
