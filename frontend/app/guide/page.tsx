    ...
    <main className="min-h-screen bg-white py-12 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-16">
          <span className="badge badge-purple mb-6 text-base">Guide d'utilisation</span>
          <h1 className="text-4xl md:text-5xl font-bold mb-6 text-gray-900">
            Comment utiliser Agents Métiers
          </h1>
        ...
        <div className="mb-20">
          ...
          <div className="sojai-card mb-10 bg-gray-50">
            <div className="space-y-8">
              {[
                ...
                <div key={agent.num} className="bg-white rounded-xl p-8 border-2 border-gray-200">
                  <div className="flex items-start gap-6 mb-6">
                    <div className="w-16 h-16 flex-shrink-0 rounded-xl bg-gradient-purple-pink text-white flex items-center justify-center text-3xl shadow-lg">
                      {agent.icon}
                    </div>
                    <div className="flex-1">
                      <div className="text-sm font-bold text-purple mb-2">AGENT {agent.num}</div>
                      <h3 className="text-2xl font-bold mb-3 text-gray-900">{agent.name}</h3>
                      <div className="inline-block bg-purple-100 text-purple px-3 py-1 rounded-lg text-sm font-bold mb-3">
                        {agent.role}
                      </div>
                      <p className="text-lg text-gray-700 leading-relaxed mb-4">{agent.desc}</p>
                      <div className="bg-gray-50 rounded-lg p-4 border-l-4 border-purple">
          ...
          <div className="sojai-card bg-purple-50 border-purple-200">
            <h3 className="text-xl font-bold mb-4 text-purple">🔄 Comment ils travaillent ensemble ?</h3>
            <div className="space-y-3 text-lg text-gray-700 leading-relaxed">
              ...
              <p className="ml-6">↓</p>
              <p className="text-purple font-bold">✅ Fiche complète et prête !</p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-20">
          ...
          <div className="space-y-10">
            {/* Étape 1 : Dashboard */}
            <div className="sojai-card border-2 border-purple">
              <div className="flex gap-6 mb-6">
                <div className="w-20 h-20 flex-shrink-0 rounded-xl bg-purple text-white flex items-center justify-center text-3xl font-bold shadow-lg">
                  1
                </div>
                <div>
                  <h3 className="text-2xl font-bold mb-2 text-purple">📊 Consulter le Dashboard</h3>
              ...
              <div className="space-y-4 mb-6">
                <p className="text-lg text-gray-700 leading-relaxed">
                  <strong>Où aller ?</strong> Cliquez sur <span className="bg-purple-100 text-purple px-2 py-1 rounded font-bold">Dashboard</span> dans le menu en haut
                </p>
            ...
            <div className="sojai-card border-2 border-purple">
              <div className="flex gap-6 mb-6">
                ...
                <div>
                  <h3 className="text-2xl font-bold mb-2 text-purple">📋 Rechercher une Fiche</h3>
              ...
              <div className="space-y-4 mb-6">
                <p className="text-lg text-gray-700 leading-relaxed">
                  <strong>Où aller ?</strong> Cliquez sur <span className="bg-purple-100 text-purple px-2 py-1 rounded font-bold">Fiches</span> dans le menu en haut
                </p>
                ...
                <div className="bg-gray-50 rounded-xl p-6">
                  ...
                  <div className="space-y-4">
                    <div className="bg-white rounded-lg p-4 border border-gray-200">
                      <p className="font-bold text-purple mb-2">Méthode 1 : Par nom de métier</p>
                    ...
                    <div className="bg-white rounded-lg p-4 border border-gray-200">
                      <p className="font-bold text-purple mb-2">Méthode 2 : Par code ROME</p>
                    ...
                    <div className="bg-white rounded-lg p-4 border border-gray-200">
                      <p className="font-bold text-purple mb-2">Méthode 3 : Par statut</p>
                ...
                <div className="bg-purple-50 rounded-xl p-6 border-l-4 border-purple">
                  <p className="font-bold text-purple mb-2">💡 Conseil</p>
            ...
            <div className="sojai-card border-2 border-purple">
              <div className="flex gap-6 mb-6">
                ...
                <div>
                  <h3 className="text-2xl font-bold mb-2 text-purple">🔧 Lancer des Actions</h3>
              ...
              <div className="space-y-4 mb-6">
                <p className="text-lg text-gray-700 leading-relaxed">
                  <strong>Où aller ?</strong> Cliquez sur <span className="bg-purple-100 text-purple px-2 py-1 rounded font-bold">Actions</span> dans le menu en haut
                </p>
        ...
        <div className="mb-20">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="sojai-card bg-gray-50">
                <h3 className="text-lg font-bold text-purple mb-3">{faq.q}</h3>
        ...
        {/* Besoin d'aide */}
        <div className="sojai-card bg-purple text-white text-center">
