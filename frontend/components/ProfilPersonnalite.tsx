...
import { SectionAnchor, SourceTag, PURPLE, PINK, CYAN } from "@/components/FicheShared";
import {
  PieChart, Pie, Tooltip, Cell, ResponsiveContainer,
  RadarChart, PolarGrid, PolarAngleAxis, PolarRadiusAxis, Radar,
} from "recharts";

interface ProfilPersonnaliteProps {
  fiche: FicheDetail;
  traitsPersonnalite?: unknown[];
  t: Record<string, any>;
}

export default function ProfilPersonnalite({ fiche, traitsPersonnalite, t }: ProfilPersonnaliteProps) {
  const traitColors = [
  ...
  return (
    <SectionAnchor id="profil" title={t.secProfile} icon="🧠" accentColor="#00C8C8">
      ...
      {traitsPersonnalite && traitsPersonnalite.length > 0 && (
        <div className="mb-8">
